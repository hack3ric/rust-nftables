...
pub fn single_string_to_option_vec<'de, D>(
    deserializer: D,
) -> Result<Option<Cow<'static, [Cow<'static, str>]>>, D::Error>
where
...
pub fn single_string_to_vec<'de, D>(
    deserializer: D,
) -> Result<Cow<'static, [Cow<'static, str>]>, D::Error>
where
    D: de::Deserializer<'de>,
{
    struct StringOrVec(PhantomData<Cow<'static, [Cow<'static, str>]>>);
    impl<'de> de::Visitor<'de> for StringOrVec {
        type Value = Cow<'static, [Cow<'static, str>]>;
